...
export function AppFooter(){
    ...
    <footer className="bg-secondary text-primary">
      ...
      <div className="my-12 px-5 py-20 lg:ml-44">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Info Perusahaan */}
          <div className="space-y-4">
            <h3 className="text-2xl font-semibold">Perusahaan</h3>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="/portfolio" className="hover:text-white transition-colors">Portofolio</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start space-x-3">
                ...
                <span>Jl. Dimana Saja No. 123<br/>Atlantis, 1236969</span>
              </li>
              <li className="flex items-center space-x-3">
                <svg className="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <a href="mailto:hello@company.com" className="hover:text-white transition-colors">hello@company.com</a>
              </li>
              <li className="flex items-center space-x-3">
                <svg className="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
